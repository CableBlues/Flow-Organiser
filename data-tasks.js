...
const TASK_ICONS = {
  ...
  'Duschen': 'shower-head', 'Take a shower': 'shower-head', 'Ducharse': 'shower-head', 'Ντους': 'shower-head', 'Prendre une douche': 'shower-head', 'Fare la doccia': 'shower-head',
  'Aufräumen': 'package', 'Tidy up': 'package', 'Ordenar': 'package', 'Τακτοποίηση': 'package', 'Ranger': 'package', 'Riordinare': 'package',
  ...
  'Wäsche aufhängen': 'towel-rack', 'Hanging up laundry': 'towel-rack', 'Colgar la ropa': 'towel-rack', 'Άπλωμα ρούχων': 'towel-rack', 'Étendre le linge': 'towel-rack', 'Stendere il bucato': 'towel-rack',
  'Waschbecken & Spiegelschrank putzen': 'sparkles', 'Cleaning sink & mirror cabinet': 'sparkles', 'Limpiar el lavabo y espejo': 'sparkles', 'Καθαρισμός νιπτήρα & καθρέφτη': 'sparkles', 'Nettoyer lavabo & armoire à miroir': 'sparkles', 'Pulire lavandino e armadietto specchio': 'sparkles',
  ...
  'Klo putzen': 'toilet', 'Cleaning the toilet': 'toilet', 'Limpiar el váter': 'toilet', 'Καθαρισμός λεκάνης': 'toilet', 'Nettoyer les toilettes': 'toilet', 'Pulire il WC': 'toilet',
  ...
  'Nägel schneiden': 'check-circle-2', 'Clipping nails': 'check-circle-2', 'Cortarse las uñas': 'check-circle-2', 'Κόψιμο νυχιών': 'check-circle-2', 'Se couper les ongles': 'check-circle-2', 'Tagliare le unghie': 'check-circle-2',
