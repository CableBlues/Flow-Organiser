(() => {
  ...
  var customTranslations2 = {
    de: {
      ...
      next_rec: "Deine Empfehlung f\xFCr jetzt",
      complete_btn: "Erledigt",
      complete: "Erledigt",
      complete_task: "Erledigt",
      feedback_greet: "Hey, ich bin Jannis! \u{1F44B}",
      feedback_prompt: "Hast du Feedback, Kritik oder neue Ideen f\xFCr Flow? Schreib mir gerne eine kurze Nachricht \u2013 ich freue mich \xFCber jeden Impuls!",
      feedback_alt: "oder sende mir eine E-Mail an jmonke@gmail.com",
      feedback_placeholder: "Deine Gedanken, W\xFCnsche oder Ideen...",
      send: "Senden",
      whatnow: "Was nun?",
      cooking: "Kochen",
      ...
      weekly_activity: "Aktivit\xE4t der letzten 7 Tage",
      loading_stats: "Deine Erfolge werden geladen...",
      export: "Als Bild sichern",
      login_btn: "Anmelden",
      sync_title: "Ger\xE4te abgleichen",
      sync_desc: "Sichere deinen Plan und nutze ihn nahtlos auf all deinen Ger\xE4ten.",
      notesPlaceholder: "Hier ist Platz f\xFCr deine Notizen, spontanen Gedanken oder Geistesblitze...",
      ...
      dropdown_placeholder: "W\xE4hle eine Aufgabe...",
      next_suggestion: "N\xE4chster Vorschlag",
    ...
    en: {
      ...
      complete: "Done",
      complete_task: "Done",
      feedback_greet: "Hey, I'm Jannis! \u{1F44B}",
    ...
    es: {
      ...
      pause_btn: "Pausa",
      standard_mode: "Modo Est\xE1ndar",
      next_rec: "Tu recomendaci\xF3n para ahora",
      complete_btn: "Hecho",
      complete: "Hecho",
      complete_task: "Hecho",
      feedback_greet: "\xA1Hola, soy Jannis! \u{1F44B}",
      feedback_prompt: "\xBFTienes comentarios, sugerencias o nuevas ideas para Flow? \xA1Escr\xEDbeme un mensaje corto, agradezco cualquier aporte!",
      feedback_alt: "o env\xEDame un correo a jmonke@gmail.com",
      ...
      rate_stat: "Tasa de \xE9xito",
      weekly_activity: "Actividad de los \xFAltimos 7 d\xEDas",
      ...
      sync_desc: "Guarda tu plan y accede a \xE9l sin problemas en todos tus dispositivos.",
      notesPlaceholder: "Un espacio acogedor para tus notas, borradores o ideas repentinas...",
      toast_no_undo: "No hay nada m\xE1s que deshacer.",
      toast_undo_applied: "\xDAltimo paso deshecho.",
      toast_reset_success: "Tu plan se ha restablecido por completo.",
      toast_import_success: "\xA1Tu plan se carg\xF3 con \xE9xito!",
      toast_import_error: "\xA1Ups! Error al importar el archivo.",
      ...
      toast_appointment_saved: "\xA1Tu cita ha sido guardada!",
      appointment_new_btn: "Nueva cita",
      appointment_form_title: "A\xF1adir cita",
      appointment_form_name_placeholder: "\xBFQu\xE9 tienes pendiente? (p. ej. dentista)",
      appointment_form_date_label: "Cu\xE1ndo",
      ...
      dopamine_kick_title: "\xBFNecesitas un impulso r\xE1pido de dopamina? \u26A1",
      dopamine_kick_start: "\xA1Dame uno!",
      dopamine_kick_done: "\xA1Hecho!",
      dopamine_kick_other: "Otra sugerencia",
      dopamine_kick_completed_toast: "\xA1Impulso de dopamina completado! Muy bien hecho.",
    ...
    el: {
      ...
      feedback_greet: "\u0393\u03B5\u03B9\u03B1, \u03B5\u03AF\u03BC\u03B1\u03B9 \u03BF Jannis! \u{1F44B}",
    ...
    fr: {
      ...
      complete: "Termin\xE9",
      complete_task: "Termin\xE9",
      feedback_greet: "Salut, je suis Jannis ! \u{1F44B}",
      feedback_prompt: "As-tu des retours, des suggestions ou de nouvelles id\xE9es pour Flow ? N'h\xE9site pas \xE0 m'\xE9crire un court message \u2013 j'appr\xE9cie chaque contribution !",
      feedback_alt: "ou envoie-moi un e-mail \xE0 jmonke@gmail.com",
      feedback_placeholder: "Tes pens\xE9es, souhaits ou id\xE9es...",
      send: "Envoyer",
      whatnow: "Et maintenant ?",
      cooking: "Cuisiner",
      cook_add_ingredient: "Ajouter",
      cook_add_ingredient_placeholder: "Entrer un ingr\xE9dient...",
      cook_suggest: "Sugg\xE9rer une recette \u{1F373}",
      cook_pantry_empty: "Ton garde-manger est vide. Ajoute des ingr\xE9dients ci-dessus !",
      cook_suggestion_title: "Suggestion de recette",
      cook_steps: "\xC9tapes de pr\xE9paration",
      cook_ingredients: "Tes ingr\xE9dients",
      cook_time: "Temps",
      cook_tags: "Tags",
      report: "Statistiques",
      report_title: "Tes r\xE9ussites",
      completed_stat: "Accompli",
      rate_stat: "Taux de r\xE9ussite",
      weekly_activity: "Activit\xE9 des 7 derniers jours",
      loading_stats: "Chargement de tes r\xE9ussites...",
      export: "Enregistrer comme image",
      login_btn: "Se connecter",
      sync_title: "Synchroniser les appareils",
      sync_desc: "S\xE9curise ton plan et acc\xE8de-y en toute fluidit\xE9 sur tous tes appareils.",
      notesPlaceholder: "Un espace chaleureux pour tes notes, brouillons ou id\xE9es soudaines...",
      toast_no_undo: "Il n'y a plus rien \xE0 annuler.",
      toast_undo_applied: "Derni\xE8re \xE9tape annul\xE9e.",
      toast_reset_success: "Ton plan a \xE9t\xE9 enti\xE8rement r\xE9initialis\xE9.",
      toast_import_success: "Ton plan a \xE9t\xE9 charg\xE9 avec succ\xE8s !",
      toast_import_error: "Oups ! \xC9chec de l'importation du fichier.",
      ...
      toast_appointment_saved: "Ton rendez-vous a \xE9t\xE9 enregistr\xE9 !",
      appointment_new_btn: "Nouveau rendez-vous",
      appointment_form_title: "Ajouter un rendez-vous",
      appointment_form_name_placeholder: "Qu'est-ce qui est pr\xE9vu ? (ex. dentiste)",
      ...
      dropdown_placeholder: "Choisir une t\xE2che...",
      ...
      dopamine_kick_completed_toast: "Coup de dopamine r\xE9ussi ! Tr\xE8s bien jou\xE9.",
      dopamine_kick_success_log: "Coup de dopamine ma\xEEtris\xE9 :",
    ...
    it: {
      ...
      pause_btn: "Pausa",
      standard_mode: "Modalit\xE0 Standard",
      next_rec: "Il tuo consiglio per adesso",
      complete_btn: "Fatto",
      complete: "Fatto",
      complete_task: "Fatto",
      feedback_greet: "Ciao, sono Jannis! \u{1F44B}",
      ...
      cook_suggest: "Suggerisci ricetta \u{1F373}",
      ...
      weekly_activity: "Attivit\xE0 degli ultimi 7 giorni",
      ...
      toast_no_undo: "Non c'\xE8 pi\xF9 nulla da annullare.",
      toast_undo_applied: "Ultimo passaggio annullato.",
      toast_reset_success: "Il tuo piano \xE8 stato completamente ripristinato.",
      toast_import_success: "Il tuo piano \xE8 stato caricato con successo!",
      ...
      toast_appointment_saved: "Il tuo appuntamento \xE8 stato salvato!",
      appointment_new_btn: "Nuovo appuntamento",
      appointment_form_title: "Aggiungi appuntamento",
      appointment_form_name_placeholder: "Cosa c'\xE8 in programma? (es. dentista)",
      ...
      dropdown_placeholder: "Seleziona un'attivit\xE0...",
  ...
  var targetTranslations = typeof TRANSLATIONS !== "undefined" ? TRANSLATIONS : window.TRANSLATIONS || {};
  if (typeof window.TRANSLATIONS === "undefined") {
    window.TRANSLATIONS = targetTranslations;
  }
  for (const lang in customTranslations2) {
    if (!targetTranslations[lang]) {
      targetTranslations[lang] = {};
    }
    Object.assign(targetTranslations[lang], customTranslations2[lang]);
  }
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      if (dayAppointments.length > 0) {
        const listStr = dayAppointments.map((t3) => {
          ...
          return `${t3.time || "Ganzt\xE4gig"} \xB7 ${t3.task}${loc}`;
        }).join("\n");
